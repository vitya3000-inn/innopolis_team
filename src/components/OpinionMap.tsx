...
import { colors, typography, spacing, borderRadius, stanceColors } from '../constants/theme';
...
export default function OpinionMap({ opinions }: OpinionMapProps) {
  // Группируем мнения по позициям
  const groupedOpinions = opinions.reduce((acc, opinion) => {
